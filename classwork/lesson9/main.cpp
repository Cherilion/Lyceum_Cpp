...
void equal_size(string&, string&);
string big_int_sum(string, string);
string big_int_sub(string, string);
...
int main()
{
    ...
    cout << "Sum = " << big_int_sum(num1, num2) << endl;
...
string big_int_sum(string str1, string str2)
{
    ...
    {
        int temp = (str1[i] - '0') + (str2[i] - '0') + in_mind;
